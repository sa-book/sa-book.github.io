...
pkgs <- c("fontawesome", "glue", "gt", "kableExtra", "knitr", "tidyverse") 
...
tibble(`Table of Contents (with link to subpage)` = c("Chapter 1 - Introduction",
       ...
       `Download link (*.zip)` = c("*No code*", 
                glue('[{fontawesome::fa("far fa-file-archive")} Chapter 0{aux}.zip](source/Chapter0{aux}.zip)'), 
                "*No code*", "*No code*")) %>% 
