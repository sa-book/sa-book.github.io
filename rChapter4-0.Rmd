...
|                                                                             | [Partitional clustering](rChapter4-1.html) | 
|                                                                             | [Cluster quality indices](rChapter4-1.html) | 
...
| 4.4	Using typologies as dependent and independent variables                 | [Clusters as outcomes](rChapter4-3.html) | 
|                                                                             | [Clusters as predictors](rChapter4-4.html) | 


Chapter 4 considers how to use the dissimilarity matrices to identify groups in data by using different clustering techniques. The resulting typology is further analyzed either as a categorical independent or dependent variable within a regression framework.  [to be finalized]
