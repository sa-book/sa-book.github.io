...
```{r bonusplot, layout="l-body-outset"}
...
```{r, eval=TRUE, echo=TRUE, results='hide'}
png(file = here("images", "Chapter2", "2-4-0_bonus_dplot_grayYearly.png"), 
    width = 900, height = 650, res = 90)
...
knitr::include_graphics("images/Chapter2/2-4-0_bonus_dplot_grayYearly.png")
```

### Monthly sequence data

```{r, eval=TRUE, echo=TRUE, results='hide'}
png(file = here("images", "Chapter2", "2-4-0_bonus_dplot_grayMonthly.png"), 
    width = 900, height = 650, res = 90)
...
```{r layout="l-body-outset"}
knitr::include_graphics("images/Chapter2/2-4-0_bonus_dplot_grayMonthly.png")
```
