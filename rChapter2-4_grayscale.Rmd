...
We use base R's `gray.colors` function to choose grays appropriate for our purpose. We apply the following strategy: 

(1) choose a "color" for each partnership state; 
(2) add shading lines for fertility information.
...
include_graphics("images/Chapter2/2-4-0_bonus_iplot_grayYearly.png")
```
