...
For the code necessary to order the sequences based on the family trajectories only, see the R-code "5-5_Fig5-2_MCSA_colors_mds_family.R" in the folder "Chapter05.zip" at the download page. There you also find an alternative approach to the plot shown above using `ggseqplot::ggseqiplot` instead of `TraMineR::seqIplot` (see [here for the corresponding tutorial](rChapter5-5_ggseqplot.html))