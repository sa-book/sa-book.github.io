...
Please note that most of the materials on this site are designed to be used in tandem with the book published by SAGE (`r fontawesome::fa("shopping-cart")` pre-order from [SAGE](https://us.sagepub.com/en-us/nam/sequence-analysis/book272086){target="_blank"} or [Amazon](https://www.amazon.com/dp/B09MJCBKC3/ref=cm_sw_em_r_mt_dp_YDSYM9W43ZEDWMZK27PV){target="_blank"}). 
