...
This site is intended to enhance your use of the book **Sequence Analysis** by Marcel Raab & Emanuela Struffolino. On this webpage we provide accompanying material illustrating how to conduct sequence analysis in `r icon_style(fontawesome("r-project"), fill = "#384CB7")` using `{TraMineR}`, `{TraMineRExtras}` [@gabadinho2011] ^[visit [`r fontawesome::fa("link")` `{TraMineR}` website](http://traminer.unige.ch){target="_blank"} for further information ] , and `{WeightedCluster}` [@studer2013].
