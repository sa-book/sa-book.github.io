...
|-------------------------------------|-------------------------------|
| 3.1 Dissimilarity measures to compare sequences                  | [Create example sequences](rChapter3-1.html) |
| 3.2 Alignment techniques                                         | [Optimal matching (OM)](rChapter3-2.html) |
